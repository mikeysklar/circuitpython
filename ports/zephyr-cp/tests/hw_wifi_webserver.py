...
---------------------------------------------------------------------------
An earlier version of this file predicted that CONFIG_ZVFS_OPEN_MAX=8 would be
the binding constraint, with accept() failing around 5-6 concurrent
connections. THAT PREDICTION WAS WRONG, and it is recorded here because it is
