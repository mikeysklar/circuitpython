...
// Native machine code (viper/native .mpy files and, with the emitter built in,
// @micropython.native functions compiled on the board) is assembled in ordinary RAM, which on
